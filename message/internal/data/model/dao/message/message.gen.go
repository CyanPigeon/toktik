...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.UIDSend = field.NewInt64(tableName, "uid_send")
	_message.UIDReceive = field.NewInt64(tableName, "uid_receive")
	_message.Content = field.NewString(tableName, "content")
	_message.CreatedBy = field.NewInt64(tableName, "created_by")
	_message.CreatedTime = field.NewTime(tableName, "created_time")
	_message.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_message.UpdatedTime = field.NewTime(tableName, "updated_time")
...
type message struct {
	...
	UIDSend     field.Int64  // 发送UID;发送用户
	UIDReceive  field.Int64  // 接收用户;接收用户
	Content     field.String // 内容;内容
...
func (m *message) updateTableName(table string) *message {
	...
	m.UIDSend = field.NewInt64(table, "uid_send")
	m.UIDReceive = field.NewInt64(table, "uid_receive")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["uid_send"] = m.UIDSend
	m.fieldMap["uid_receive"] = m.UIDReceive

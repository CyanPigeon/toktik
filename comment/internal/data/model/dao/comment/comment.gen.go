...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.UserUID = field.NewInt64(tableName, "user_uid")
	_comment.VideoID = field.NewInt64(tableName, "video_id")
	_comment.Content = field.NewString(tableName, "content")
	_comment.CreatedBy = field.NewInt64(tableName, "created_by")
	_comment.CreatedTime = field.NewTime(tableName, "created_time")
	_comment.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_comment.UpdatedTime = field.NewTime(tableName, "updated_time")
	_comment.Delete = field.NewBool(tableName, "delete")
...
type comment struct {
	...
	ALL         field.Asterisk
	CommentID   field.Int64  // 评论ID;评论id
	UserUID     field.Int64  // 用户UID;用户ID
	VideoID     field.Int64  // 视频ID;视频ID
	Content     field.String // 评论;评论
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.UserUID = field.NewInt64(table, "user_uid")
	...
	c.Delete = field.NewBool(table, "delete")

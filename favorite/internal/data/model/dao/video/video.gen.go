...
func newVideo(db *gorm.DB, opts ...gen.DOOption) video {
	...
	_video.UserUID = field.NewInt64(tableName, "user_uid")
	_video.Descripath = field.NewString(tableName, "descripath")
	...
	_video.CreatedBy = field.NewInt64(tableName, "created_by")
	_video.CreatedTime = field.NewTime(tableName, "created_time")
	_video.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_video.UpdatedTime = field.NewTime(tableName, "updated_time")
	_video.Delete = field.NewBool(tableName, "delete")
...
type video struct {
	...
	ALL          field.Asterisk
	VideoID      field.Int64  // 视频ID;视频主键
	UserUID      field.Int64  // 用户UID;用户UID
	Descripath   field.String // 描述;描述
	Title        field.String // 标题;标题
	CoverPath    field.String // 封面地址;封面地址
	VideoPath    field.String // 视频地址;视频地址
	LikeCount    field.Int64  // 点赞数;点赞数，默认0
	CommentCount field.Int64  // 评论数;评论数量，默认0
...
func (v *video) updateTableName(table string) *video {
	...
	v.UserUID = field.NewInt64(table, "user_uid")
	v.Descripath = field.NewString(table, "descripath")
	...
	v.CreatedTime = field.NewTime(table, "created_time")
	v.UpdatedBy = field.NewInt64(table, "updated_by")
	v.UpdatedTime = field.NewTime(table, "updated_time")
	v.Delete = field.NewBool(table, "delete")
...
func (v *video) fillFieldMap() {
	...
	v.fieldMap["user_uid"] = v.UserUID
	v.fieldMap["descripath"] = v.Descripath
	...
	v.fieldMap["updated_time"] = v.UpdatedTime
	v.fieldMap["delete"] = v.Delete
}

...
import (
	...
	"user/cmd/gen/internal/data/model"
)
...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.UserUID = field.NewInt64(tableName, "user_uid")
	_follow.FollowUID = field.NewInt64(tableName, "follow_uid")
	_follow.CreatedBy = field.NewInt64(tableName, "created_by")
	_follow.CreatedTime = field.NewTime(tableName, "created_time")
	_follow.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_follow.UpdatedTime = field.NewTime(tableName, "updated_time")
	_follow.Delete = field.NewBool(tableName, "delete")
...
type follow struct {
	...
	ALL         field.Asterisk
	FollowID    field.Int64 // 关注ID;关注表的
	UserUID     field.Int64 // 主动关注人的UID;主动关注人的UID
	FollowUID   field.Int64 // 关注人的UID;关注人的UID
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.UserUID = field.NewInt64(table, "user_uid")
	f.FollowUID = field.NewInt64(table, "follow_uid")
	f.CreatedBy = field.NewInt64(table, "created_by")
	f.CreatedTime = field.NewTime(table, "created_time")
	f.UpdatedBy = field.NewInt64(table, "updated_by")
	f.UpdatedTime = field.NewTime(table, "updated_time")
	f.Delete = field.NewBool(table, "delete")
